...
variable "bookstackdb_cfg_default_mountpoint" {
  type        = string
  description = "Absolute Path location of DataBase"
  default     = "/media/docker/containers/bookstack/db/config"
}

variable "bookstackapp_cfg_default_mountpoint" {
  type        = string
  description = "Absolute Path location of Application"
  default     = "/media/docker/containers/bookstack/app/config"
}
